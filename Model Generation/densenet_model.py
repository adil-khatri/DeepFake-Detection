...
real_dir = './img_align_celeba'  #dataset folder Since to large it is not uploaded on github (Download celeb dataset)
eval_partition = pd.read_csv('./DenseNet Evaluation/list_eval_partition.csv')
...
densenet = DenseNet121(
    weights='./DenseNet Evaluation/DenseNet-BC-121-32-no-top.h5',
    include_top=False,
